        ...
        public class XArena {
            ...
            public class XTile {
                ...
                public void xpipe() {
                    switch (type) {
                        case 0:
                            pipes.set(new boolean[]{false, true, true, false});
                            break;
                        case 1:
                            pipes.set(new boolean[]{false, false, true, true});
                            break;
                        case 2:
                            pipes.set(new boolean[]{true, false, false, true});
                            break;
                        case 3:
                            pipes.set(new boolean[]{true, true, false, false});
                            break;
                        case 4:
                            pipes.set(new boolean[]{false, true, false, true});
                            break;
                        case 5:
                            pipes.set(new boolean[]{true, false, true, false});
                            break;
                        case 6:
                            pipes.set(new boolean[]{true, true, false, true});
                            break;
                        case 7:
                            pipes.set(new boolean[]{true, true, true, false});
                            break;
                        case 8:
                            pipes.set(new boolean[]{false, true, true, true});
                            break;
                        case 9:
                            pipes.set(new boolean[]{true, false, true, true});
                            break;
                        case 10:
                            pipes.set(new boolean[]{true, true, true, true});
                            break;
                        case 11:
                            pipes.set(new boolean[]{false, false, true, false});
                            break;
                        case 12:
                            pipes.set(new boolean[]{false, false, false, true});
                            break;
                        case 13:
                            pipes.set(new boolean[]{true, false, false, false});
                            break;
                        case 14:
                            pipes.set(new boolean[]{false, true, false, false});
                            break;
                        case 15:
                            pipes.set(new boolean[]{false, false, false, false});
                            break;
                    }
                }
